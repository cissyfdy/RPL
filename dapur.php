                                ...
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="sumbit" class="btn btn-primary" name="terima_orderitem_validate"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button type="sumbit" class="btn btn-primary" name="siapsaji_orderitem_validate"
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <button class="<?php echo (empty($row['status'])|| $row['status']!=1)  ? "btn btn-secondary
                                     btn-sm me-1 text-nowrap disabled" : "btn btn-success btn-sm me-1 text-nowrap"; ?>" data-bs-toggle="modal"
